...
public class TextureLoader {
	...
	private Hashtable<String, Texture> textureCache;
    ...
    private TextureLoader() {
        ...
        textureCache = new Hashtable<String, Texture>();
    }
    ...
    public Texture getTexture(String resourceName) throws IOException {
    	...
    	Texture tex = textureCache.get(resourceName);
    	if (tex == null) {
    		...
    		textureCache.put(resourceName, tex);
    	}
        return tex;
    }
